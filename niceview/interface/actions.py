...
def clear_cache_forcall(*args):
    ...
    chat_dir = os.environ.get("COPILOT_CHAT_DIR", os.path.join(project_root, "chat_sessions"))
    tmp_base = os.environ.get("COPILOT_TMP_BASE", os.path.join(project_root, "tmp_data"))
